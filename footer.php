...
?>
	...
	<?php endif; ?>
		...
		<div class="ak-container">
			<h1 class="site-info">
				<a href="<?php echo esc_url( __( 'http://wordpress.org/', 'accesspresslite' ) ); ?>"><?php //_e( 'WordPress Version 4.1.1', 'accesspresslite' ); ?></a>
				<span class="sep">  </span>
			...
			<div class="copyright">
                                 ...
                                 <img style="height:37px;" src="<?php echo get_template_directory_uri(); ?>/images/demo/footerimage.png">
                                 <br>
