...
<article id="post-<?php the_ID(); ?>" class="cat-event-list">
		...
		<div class="event-date-archive">
                    <?php //echo get_cat_name( $cat_event )?> <?php echo $accesspresslite_event_day." ".$accesspresslite_event_month." , ".$accesspresslite_event_year ?>
                </div>
	...
	<div class="entry-content">
		...
		<a href="<?php the_permalink(); ?>" class="cat-event-more bttn"><?php _e('Event Detail','accesspresslite');?></a>
	</div><!-- .entry-content -->
