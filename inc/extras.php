    ...
    ?>     
				...
				<div class="slides">
                    ...
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
                                <div class="slider-caption" style="background:none ! important;">
                                        <div class="">
				...
				<div class="slides">
					...
					<div class="slider-caption">
						<div class="ak-container">
                                                    <h1 class="caption-title"> 44th National Convention</h1>
							<h2 class="caption-description"></h2>
						</div>
					</div>
                    <?php  //endif; ?>
				...
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider3.jpg" alt="slider1">
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
					<div class="slider-caption" >
						<div class="ak-container">
							<h1 class="caption-title"> June 10-14, 2016</h1>
                                                       <!-- <h2 class="caption-description">
                                                            <span style="text-shadow: 0px 0px 21px #000;">Schaumburg, IL</span>
                                                        </h2>
                                                       -->
						</div>
					</div>
				...
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider6.jpg" alt="slider1">
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
				...
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider7.jpg" alt="slider1">
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
					<div class="slider-caption" style="background:none ! important;">
						<div class="">
							<h1 class="caption-title"> </h1>
				...
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider9.jpg" alt="slider1">
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
                                        
                                        <div class="slider-caption" style="background:none;">
						<div class="ak-container">
							<h1 class="caption-title">#WhatWillMatter16</h1>
							<h2 class="caption-description"></h2>
						 </div>
					</div>
				...
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider11.jpg" alt="slider1">
                    <?php //if($accesspresslite_settings['slider_caption']=='yes4' || empty($accesspresslite_settings['slider_caption'])):?>
					<div class="slider-caption" style="background:none ! important;">
						<div class="">
							<h1 class="caption-title"> </h1>
...
<!-- end custom code ------------------------------------------------------------------------------------------ -->            
   ...
   add_filter( 'body_class', 'accesspresslite_web_layout' );
	...
	function accesspresslite_call_to_action_cb(){
		...
		<div class="ak-container">
			<h4> Tri Sigma More<?php //echo $accesspresslite_settings['action_text']; ?></h4>
			<a class="action-btn" href="<?php echo $accesspresslite_settings['action_btn_link']; ?>">More<?php //echo $accesspresslite_settings['action_btn_text']; ?></a>
		</div>
		</section>
		<?php
		}
