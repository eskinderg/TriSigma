...
if ( ! function_exists( 'accesspresslite_paging_nav' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 *
 * @return void
 */
function accesspresslite_paging_nav() {
...
if ( ! function_exists( 'accesspresslite_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 *
 * @return void
 */
function accesspresslite_post_nav() {
 ...
 */
function accesspresslite_categorized_blog() {
	...
	if ( '1' != $all_the_cool_cats ) {
		// This blog has more than 1 category so accesspresslite_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so accesspresslite_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in accesspresslite_categorized_blog.
 */
function accesspresslite_category_transient_flusher() {
	// Like, beat it. Dig?
