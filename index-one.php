...
<div id="welcome-text" class="clearfix <?php echo $welcome_class; ?>">
	<?php
			...
			$query1 = new WP_Query( $args );
				...
				<!--
				<h1><a href="#"><?php _e('WordPress Version 4.1.1',''); ?></a></h1>
				<figure class="welcome-text-image">
				<a href="#">
				...
				<p><?php _e('HTML5 & CSS3 Responsive clean, minimal yet highly professional design.','accesspresslite'); ?></p>
<p><?php _e('Developed this theme and given back to this awesome WordPress community. It is feature rich, multi purpose and flexible responsive theme Suitable for Agencies, Small Biz, Corporates, Bloggers - Anyone and Everyone!','accesspresslite'); ?></p>
<p><?php _e('The theme is complete with many useful features. The intuitive theme options let you manage all the possible options/features of the theme. You can use it to create your next superb website.','accesspresslite'); ?></p>
...
<section id="bottom-section">
	<div class="ak-container">
        ...
        <aside id="text-3" class="widget widget_text">
            <h3 class="widget-title"><?php _e('Features','accesspresslite'); ?></h3>
